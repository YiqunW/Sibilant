...
%%%% Need to fix the code in function ndhist to be able to use
%%%% n=[mbin,sbin] (currently can only use n=nbins.
...
%            n - size of the n by m grid over which the density is computed
